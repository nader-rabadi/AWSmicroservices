...
def run_state_machine(valerror):
    """
    This functions starts the execution of a state machine, and and immediately
...
def lambda_handler(event, context):
    ...
    body = json.dumps({'message': 'Report accepted successfully'})
    ...
    try:
        valerror = {'error':''}
        response = run_state_machine(valerror)
