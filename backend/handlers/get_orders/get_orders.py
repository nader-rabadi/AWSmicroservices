...
def get_orders_from_ddb(table_name, valerror):
    """
    This function gets all orders from DynamoDB table
...
def lambda_handler(event, context):
    ...
    try:        
        valerror = {'error':''}
        orders = get_orders_from_ddb(ddb_table_name, valerror)
