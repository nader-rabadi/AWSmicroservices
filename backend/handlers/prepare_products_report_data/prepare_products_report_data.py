...
ddb_products_table_name = os.environ['PRODUCTS_TABLE']
...
def lambda_handler(event, context):
    ...
    try:        
        ...
        valerror = {'error':''}
        products = get_data_from_ddb(ddb_products_table_name, valerror)
        if products is None:
            raise ValueError(f'Could not get data from products table')
