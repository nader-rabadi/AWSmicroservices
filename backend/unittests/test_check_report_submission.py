...
class TestCheckReportSubmission(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from handlers.check_report_submission.check_report_submission import check_submission_status
        from handlers.check_report_submission.check_report_submission import client

        self.check_report_submission = check_submission_status  # Store it in an instance variable
        self.client = client

    def tearDown(self):
        os.environ.pop('FRONTEND_URL', None) 

    @patch('handlers.check_report_submission.check_report_submission.client.describe_execution')
    @mock_aws
    def test_check_report_submission_success(self, mock_describe_execution):
        print(f'***************************************************')
        ...
        result = self.check_report_submission(executionArn, valerror)

        self.assertEqual(result, "SUCCEEDED")

    @patch('handlers.check_report_submission.check_report_submission.client.describe_execution')
    @mock_aws
    def test_check_report_submission_failure(self, mock_describe_execution):
        print(f'***************************************************')
        print(f'Unit Test: {self.__class__.__name__} : {self._testMethodName} :')
        print(f'***************************************************')
    ...
    @patch('handlers.check_report_submission.check_report_submission.client.describe_execution')
    @mock_aws
    def test_check_report_submission_value_error(self, mock_describe_execution):
        print(f'***************************************************')
        print(f'Unit Test: {self.__class__.__name__} : {self._testMethodName} :')
        print(f'***************************************************')
