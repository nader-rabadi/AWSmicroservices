...
class TestCreateReport(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from handlers.create_report.create_report import run_state_machine
        from handlers.create_report.create_report import client
    ...
    @patch('handlers.create_report.create_report.client.start_execution')
    @mock_aws
    def test_run_state_machine_success(self, mock_start_execution):
        ...
        result = self.run_state_machine(valerror)
